...
public class SpringFoxConfig {
    ...
    public static final String BANNER = "Баннеры";
    public static final String ADVERTISEMENTS = "Текстовые объявления";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .tags(new Tag(BANNER,""))
                .tags(new Tag(ADVERTISEMENTS,""))
                .tags(new Tag(PERSONAL_ACCOUNT,""))
                .tags(new Tag(ORDER,""));
    }
